...
ly_passes = ligue_1_passes_fill.loc[ligue_1_passes_fill.Season == '2021/22'].sort_values('Progressive Passes %',ascending=False).reset_index(drop=True)
cy_passes = ligue_1_passes_fill.loc[ligue_1_passes_fill.Season == '2022/23'].sort_values('Progressive Passes %',ascending=False).reset_index(drop=True)
